      ...
      <div className="container mx-auto max-w-5xl text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-up animate-delay-300 opacity-0 animation-fill-both">
          ...
          <Button
            ...
            className="rounded-full px-8 h-12 text-base font-medium w-full sm:w-auto border border-primary bg-background hover:bg-primary hover:text-primary-foreground transition-all duration-300"
          >
